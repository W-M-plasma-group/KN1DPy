...
pro run_cmod_test_idl
  ...
  ;  Run options
  ; ---------------------------------------------------------------- ;
  File           = 'examples/C-Mod/IDL_output/cmod_test'
  refine         = 0
  ReadInput      = 0
  NewFile        = 1
  compute_errors = 1
