...
Run from the KN1DPy root directory:
    ...
    python examples/C-Mod/plot_cmod_test_comparison.py

Loads outputs from:
  - examples/C-Mod/python_output/    (Python run)
  - examples/C-Mod/IDL_output/       (IDL run)
...
#  Load Python outputs
# ------------------------------------------------------------------ #
py_h  = np.load('examples/C-Mod/python_output/KN1D_H.npz')
py_h2 = np.load('examples/C-Mod/python_output/KN1D_H2.npz')
inp   = np.load('examples/C-Mod/python_output/KN1D_input.npz')
...
# ------------------------------------------------------------------ #
idl_h  = readsav('examples/C-Mod/IDL_output/cmod_test.KN1D_H')
idl_h2 = readsav('examples/C-Mod/IDL_output/cmod_test.KN1D_H2')
idl_in = readsav('examples/C-Mod/IDL_output/cmod_test.KN1D_input')
...
fig.tight_layout()
out = 'examples/C-Mod/cmod_test_comparison.png'
