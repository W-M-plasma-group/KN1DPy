...
;
   ...
   sigv=sigmav_Ion_HH(Te)
      plot,/nodata,Te,sigv*1e6,/xlog,/ylog,xrange=[0.1,2e4],xstyle=1,$
           ...
           title='e + H!D2!N -> e + H!D2!N!U+!N(v) + e',xtitle='Te (eV)',$
           ytitle='<sigma v> (cm^3/s)',xticklen=1,yticklen=1
   oplot,Te,sigv*1e6,color=2,thick=3.0
   xyouts,.15,.90,/normal,'output from idl function SIGMAV_ION_HH.PRO which evaluates the reaction rates using',charsize=0.8
